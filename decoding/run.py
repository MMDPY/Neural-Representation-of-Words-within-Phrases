...
inData_opt = ['channels']
wordvec_opt = ['skipgram', 'gpt2', 'glove'] # gpt2 dimention 726, glve dimention 200, skip dimention 300
...
whcond_opt = ['straight',  # train on x, test on x
              ...
              'phrasal',
              'adjadj'] # This has been added by us (Yousef and Mohammad)
...
# Global variables
subjects = ['AB', 'A0003', 'A0005', 'A0007', 'A0008', 'A0014', 'A0051', 'A0054', 'A0056', 'A0057', 'A0068',
...
if __name__ == '__main__':
    ...
    if args.isperm is False:
        ...
        # do_2v2_onesubj
        # all_2v2 = eval.do_2v2(range(2,4))
            all_2v2 = evaler.do_2v2_adj_adj_or_N_N(range(4, 5), range(0, 1))
        
        if args.whcond == 'noun_noun':
            # do_2v2_onesubj
            # all_2v2 = eval.do_2v2(range(2,4))
            all_2v2 = evaler.do_2v2_adj_adj_or_N_N(range(5, 6), range(1, 2))
            ...
            if args.tgm:
                ...
                all_2v2 = evaler.do_2v2_train_test_noun_adj()
            pass
        print('before matlab file')
        print(my_out_dir, subjects[my_subj], args.whcond, args.traind, args.avg)
